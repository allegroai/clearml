...
class Task(_Task):
    ...
    def close(self):
        ...
        It does not terminate the current Python process, in contrast to :meth:`Task.mark_completed`.
        ...
        However, you can "get the task back" by using methods like :meth:`Task.get_task`.
