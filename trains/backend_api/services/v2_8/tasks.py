...
class CloneRequest(Request):
    ...
    def __init__(
            self, task, new_task_name=None, new_task_comment=None, new_task_tags=None, new_task_system_tags=None, new_task_parent=None, new_task_project=None, execution_overrides=None, validate_references=None, **kwargs):
...
class GetAllRequest(Request):
    ...
    :param type: List of task types. One or more of: 'training', 'testing', 'inference',
        'data_processing', 'application', 'monitor', 'controller', 'optimizer', 'service',
        'qc' or 'custom' (case insensitive)
